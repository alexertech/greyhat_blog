...
class Visit < ApplicationRecord
  ...
  scope :bots, -> { where("user_agent ILIKE ANY (ARRAY['%bot%', '%crawler%', '%spider%', '%yahoo%', '%slurp%', '%daum%', '%yandex%', '%googlebot%', '%bingbot%', '%baiduspider%', '%twitterbot%', '%facebookexternalhit%', '%rogerbot%', '%linkedinbot%', '%embedly%', '%quora%', '%pinterest%', '%slackbot%', '%redditbot%', '%snapchat%', '%applebot%'])") }
  scope :humans, -> { where.not("user_agent ILIKE ANY (ARRAY['%bot%', '%crawler%', '%spider%', '%yahoo%', '%slurp%', '%daum%', '%yandex%', '%googlebot%', '%bingbot%', '%baiduspider%', '%twitterbot%', '%facebookexternalhit%', '%rogerbot%', '%linkedinbot%', '%embedly%', '%quora%', '%pinterest%', '%slackbot%', '%redditbot%', '%snapchat%', '%applebot%'])") }
